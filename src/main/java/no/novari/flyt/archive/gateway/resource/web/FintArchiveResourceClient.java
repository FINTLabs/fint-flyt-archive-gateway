...
public class FintArchiveResourceClient {
    ...
    public Mono<Long> getLastUpdated(String urlResourcePath) {
        ...
        return fintWebClient.get()
                ...
                .httpRequest(clientHttpRequest -> {
                    ...
                    reactorRequest.responseTimeout(properties.getGetResourcesLastUpdatedTimeout());
                })
                .retrieve()
    ...
    public Mono<List<SakResource>> findCasesWithFilter(String caseFilter) {
        return Mono.defer(() -> {
                    ...
                    return fintWebClient
                            ...
                            .httpRequest(clientHttpRequest -> {
                                HttpClientRequest reactorRequest = clientHttpRequest.getNativeRequest();
                                reactorRequest.responseTimeout(properties.getFindCasesWithFilterTimeout());
                            })
                ...
                .retryWhen(
                        Retry.backoff(
                                ...
                                properties.getFindCasesWithFilterBackoffRetryMinDelay()
                        ).maxBackoff(
                                properties.getFindCasesWithFilterBackoffRetryMaxDelay()
                        ).doBeforeRetry(
    ...
    public <T> Mono<T> getResource(String endpoint, Class<T> clazz) {
        return fintWebClient.get()
                ...
                .httpRequest(clientHttpRequest -> {
                    HttpClientRequest reactorRequest = clientHttpRequest.getNativeRequest();
                    reactorRequest.responseTimeout(properties.getGetResourceTimeout());
                })
                .retrieve()
                .bodyToMono(clazz);
    }
